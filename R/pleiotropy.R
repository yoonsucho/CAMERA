...
CAMERA$set("public", "pleiotropy", function(harmonised_dat=self$harmonised_dat_sem){
...
CAMERA$set("public", "pleiotropy_specificity", function(harmonised_dat=self$harmonised_dat_sem, sem_result=self$sem_result, pleioropy=self$pleiotropy_dat){
  stopifnot(!is.null(harmonised_dat))
