...
Open R6 class environment to run TAMR. Plink (ver.1.90) and LD reference data are also required to identify instruments that can be used for both populations: http://fileserve.mrcieu.ac.uk/ld/1kg.v3.tgz 
...
See the `?TAMR` for options on the parameters for this analysis. 
